...
def layout():
    ...
    st.markdown('<style>h1, p { color: #ffc3d5; font-family: "Arial", sans-serif;}</style>', unsafe_allow_html=True)
    st.markdown('<style>h2, p { color: #ebe1e4; font-family: "Arial", sans-serif;}</style>', unsafe_allow_html=True)
