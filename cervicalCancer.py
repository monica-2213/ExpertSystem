...
def recommend_medical_tests():
    ...
    st.markdown('<p class="header-text">Recommended Medical Tests and Screenings', unsafe_allow_html=True)
...
def provide_treatment_recommendations():
    ...
    st.markdown('<p class="header-text">Treatment Recommendations</p>', unsafe_allow_html=True)
...
def provide_helplines():
    ...
    st.markdown('<p class="header-text">Helplines (Malaysia)', unsafe_allow_html=True)
