...
def main():
    ...
    for key, question in questions.items():
        if key == 'age':
            answers[key] = st.number_input(question, min_value=18, max_value=100, step=1)
        elif key == 'diet':
    ...
    if st.button('Submit'):
        ...
        st.write(f'Based on your responses, your risk of developing cervical cancer is {risk_percentage:.2f}%.')
